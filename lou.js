var today = new Date(), current = 'default', timestamps = [], actVal = 0, curVal = 0, baseline = [], head = [], css = [], events = [];
events.push(['la semana', [ '2016-08-08', '2016-08-09', '2016-08-10', '2016-08-11', '2016-08-12', '2016-08-13', '2016-08-14' ]]);
...
css['default'] = '';
css['la semana'] = '#sidebtns { background:rgba(255,255,255,0.7); } td:nth-of-type(1) { position:relative; } td:nth-of-type(1) > img:nth-of-type(2) { position:absolute; left:136px; top:6px; width:27px; height:13px; }';
...
insertionQ('#chattbl > tr').every(function(element){
    ...
    if(!l)
    {
        $(element).children('td:nth-of-type(1)').append('<img src="https://vignette3.wikia.nocookie.net/runescape2/images/9/97/Pinata_sombrero.png" />');
