...
$('head').append('<style type="text/css">.mod { position:fixed; background:silver; border-radius:20px; padding:2px; border:1px solid #666; } #chatbox { overflow-x:hidden; display:flex; flex-direction:column-reverse; } @-moz-document url-prefix() { #chattbl { max-height:100%; display:flex; flex-direction:column; } } #chattbl > tr:not(.backlog, .log:first-of-type) { opacity:0; } header { background:' + head[Math.floor(Math.random() * head.length)] + '; text-align:center; } td:nth-of-type(3) { display:none; } #userlist div, #chat td:nth-of-type(1), #chat td:nth-of-type(1) * { cursor:pointer; -webkit-touch-callout:none; -webkit-user-select:none; -khtml-user-select:none; -moz-user-select:none; -ms-user-select:none; user-select:none; } #userlist, #input, body, tr { background:#f5f5f5 !important; } #chat td:nth-of-type(2) img { max-width:100%; max-height:360px; } #chat td:not(:last-child) { border-right:0; } #input { text-indent:5px; outline:0; border:0; border-top:1px solid #666; } #userlist { margin-bottom:120px; padding-bottom:5px; border-left:0; } #userlist div { border-bottom:0; } #chat { border-right: 1px solid #666; } #nom { margin:0 20%; text-shadow:0 1px 1px #666; padding:5px; font-weight:bold; color:#FFF; position:absolute; left:0; right:185px; } .log td:nth-of-type(2) { text-align:center; } #volrange { position:relative; top:-2px; z-index:5; } #cover { z-index:15; } #window { z-index:20; } label:not(.sound) { position:relative !important; top:3px !important; } .sound { font-size:23px; } label + img { position:relative; left:2px; margin-left:0 !important; } img { vertical-align:middle; } #chattbl > tr:nth-of-type(1) { opacity:0.2 !important; } #chattbl > tr:nth-of-type(2) { opacity:0.4 !important; } #chattbl > tr:nth-of-type(3) { opacity:0.6 !important; } #chattbl > tr:nth-of-type(4) { opacity:0.8 !important; } .mod > label { display:none; } .mod:hover > label { display:inline-block; }</style>');
$('head').append('<style type="text/css">td:nth-of-type(1) { position:relative; } td:nth-of-type(1) > img:nth-of-type(2) { position:absolute; left:137px; top:6px; width:27px; height:13px; }</style>');
