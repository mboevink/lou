...
var baseline = ['Nuit gravement à la santé', 'Petits amours épistolaires', 'L\'intelligentsia française', 'On ferme une école, on ouvre une prison', 'CIVILISE TOI FILS DE PUTE', 'Rien ne doit être pas pris en vu', 'Mauvaise expérience', 'Vous etes bizarre ici :lol:', 'donne nous le facebook', 'Pourquoi vous faites çaAAAaaaAAAaaaA'];
